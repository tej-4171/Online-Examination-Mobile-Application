...
public class A_account extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aaccount);
    ...
    public boolean onpopupmenuclick(MenuItem item){
        ...
        {
            case R.id.home:
                Intent i1 =new Intent(A_account.this,Admin.class);
            ...
            case R.id.setting:
                ...
                Intent i3 =new Intent(A_account.this,A_settings.class);
                i3.putExtra("userid", userid);
                finish();
                startActivity(i3);
                break;
            case R.id.logout:
                Intent i4 =new Intent(A_account.this,A_log.class);
                finish();
                startActivity(i4);
                break;
        }
